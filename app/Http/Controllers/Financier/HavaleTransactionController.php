...
//            ->where('status_id', $status->id)
            ...
            ->select(['id', 'client_id', 'is_active','description', 'direct_approve','created_at', 'currency_code', 'status_id', 'type_id', 'method_id', 'account_id', 'amount', 'approved_amount', 'transactionable_id', 'transactionable_type', 'edit_time'])
