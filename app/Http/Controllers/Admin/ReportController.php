...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $transactions = Transaction::with('website', 'client', 'status', 'type', 'method')->paginate(20);
    ...
    public function detail(Request $request, $id)
    {
        ...
        return view('admin.reports.detail')->with([
    ...
    public function getBankAccounts(Request $request): \Illuminate\Http\JsonResponse
    {
        $bankAccounts = BankAccount::whereHas('bank', function ($query) use ($request) {
