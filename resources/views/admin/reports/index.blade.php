    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{route('admin.transactions.reports.filter')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-2 p-0">
                            ...
                            <div class="col-2 p-0" id="website-content">
                            ...
                            <div class="col-12 d-flex justify-content-around" style="margin-top: 20px">
                                ...
                                <form action="{{route('admin.transactions.reports.index')}}" method="GET"
                                      id="clear-filter-id"
                                      name="clear-filter">
                                    ...
                                    @foreach($data as $key=> $agreement)
                                        <tr class="{{$key % 2 === 0 ? 'even':'odd'}}">
                                            ...
                                            <td class="project-actions d-flex justify-content-around">
                                                ...
                                                <form
                                                    action="{{ route('admin.transactions.reports.detail', $agreement->id) }}"
                                                    method="GET">
