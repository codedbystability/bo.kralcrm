                            ...
                            <div style="margin:0;" class="form-group col-12  d-flex">
                                <div style="margin:0;" class="form-group col-6 ">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                          <span class="input-group-text @if(isset($bank_name)) bg-primary @endif">
                                ...
                                <div style="margin:0;" class="form-group col-6 ">
                                    ...
                                    <div class="input-group" id="bank-account-container">
                                        <div class="input-group-prepend">
                                          <span class="input-group-text @if(isset($account_name)) bg-primary @endif">
                                            <i class="fas fa-people-arrows"></i>
                                          </span>
                                        </div>
                                        <input class="form-control"
                                    ...
                                    <datalist id="bankAccount">
                                        @foreach($bankAccounts as $account)
                                            <option value="{{$account->id}}"> {{$account->iban}} {{$account->currency->symbol}} </option>
                                        @endforeach
                                    </datalist>
                                </div>
                            </div>
