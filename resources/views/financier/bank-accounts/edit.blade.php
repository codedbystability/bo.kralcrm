...
@section('content-title')
    @include('layouts.content-title',['title' =>'Provider Anlasmalari','first' => 'Agreements','second' => 'Create'])
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <!-- form start -->
                <form method="POST" action="{{ route('financier.bank-accounts.update',$bankAccount->id) }}" >
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select form-control-border" name="bank_id"
                                ...
                                @foreach($banks as $providerItem)
                                    <option
                                        @if ($providerItem->id === $bankAccount->bank->id)
                                        selected="selected"
                                        @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="branch" class="form-control" type="text" placeholder="sube" required
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="min_withdraw" class="form-control" type="number" step="0.1" placeholder="min cekim"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="max_deposit" class="form-control" type="text" placeholder="max yatirim"
