                ...
                <form method="POST" action="{{ route('financier.bank-accounts.store') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="provider_id">Musteri</label>
...
{{--                        </div>--}}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <input type="hidden" name="min_withdraw" value="1.00">
                                <input type="hidden" name="max_withdraw" value="50000.00">
                                <input type="hidden" name="min_deposit" value="1.00">
                                <input type="hidden" name="max_deposit" value="50000.00">
